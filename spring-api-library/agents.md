...
always taking into account that the code will grow later.
...
- **Review:** After the changes, review the readme file, files changed, seed files, docker, and comments, to update if necessary and audit if its following the rules above